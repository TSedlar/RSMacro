...
public class Test extends Macro implements Renderable, PixelListener {
    ...
    private static final PixelModel MINIMAP_PLAYER = PixelModel.fromString("#FFFFFF/10 #FFFFFF/10/1/0 #FFFFFF/10/0/1 #FFFFFF/10/1/1");

    @Override
    public void atStart() {
        Minimap.clearItems();
        Minimap.submitItem(new MinimapItem("Boundary", "#E4E4F1", 14, Color.WHITE));
        Minimap.submitItem(new MinimapItem("Gravel", "#453F3F", 8, Color.DARK_GRAY));
        Minimap.submitItem(new MinimapItem("Sidewalk", "#77746E", 8, Color.GRAY));
        Minimap.submitItem(new MinimapItem("Dirt", "#7B7453", 4, new Color(147, 116, 78)));
        Minimap.submitItem(new MinimapItem("Dirty grass", "#5D5F35", 4, new Color(112, 139, 106)));
        Minimap.submitItem(new MinimapItem("Dark grass", "#425A3C", 4, new Color(22, 68, 38)));
        Minimap.submitItem(new MinimapItem("Grass", "#54612B", 6, new Color(47, 150, 76)));
        Minimap.submitItem(new MinimapItem("Moderate grass", "#465F35", 4, new Color(40, 129, 65)));
...
//                .filterLocation(Minimap.BOUNDS::contains)
