 ...
 * <pre><code>
 * //create the detector
 * api.util.CannyEdgeDetector detector = new api.util.CannyEdgeDetector();
...
public class CannyEdgeDetector {
    ...
    private static final CannyEdgeDetector INSTANCE = new CannyEdgeDetector();
    ...
    /**
     * Creates the edge image from the given arguments
     *
     ...
     * @param contrastNormalized If the constrast is normalized
     * @return An image containing the edges.
     */
    public static CannyEdgeModel model(BufferedImage img, float lowThreshold, float highThreshold, float kernelRadius,
                                       int kernelWidth, boolean contrastNormalized) {
        INSTANCE.setSourceImage(img);
        INSTANCE.setLowThreshold(lowThreshold);
        INSTANCE.setHighThreshold(highThreshold);
    ...
    public static CannyEdgeModel model(BufferedImage img, float lowThreshold, float highThreshold, float kernelRadius,
                                       int kernelWidth) {
        return model(img, lowThreshold, highThreshold, kernelRadius, kernelWidth, false);
    }
